...
public class PricingGUI : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		printHamSandwich.text = "$" + hamSandwichCost.ToString("#.00");
		printTurkeySandwich.text = "$" + turkeySandwichCost.ToString("#.00");
		printVeggieSandwich.text = "$" + veggieSandwichCost.ToString("#.00");
